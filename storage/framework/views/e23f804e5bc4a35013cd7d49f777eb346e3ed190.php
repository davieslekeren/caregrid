                                                ...
                                                <div class="col-sm-5">
                                                    ...
                                                    <?php $__currentLoopData = $subscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subscription_key => $subscription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <ul class="gap-2 mt-3 plan_change_info customCheckdef<?php echo e($subscription_key); ?>"
                                                            ...
                                                            <li><?php echo e(__('Client Limit')); ?> <?php echo e($subscription->client_limit); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/carecifn/public_html/preprod/resources/views/user/show.blade.php ENDPATH**/ ?>