            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center g-2">
                        <div class="col">
                            <h5><?php echo e(__('WO Type List')); ?></h5>
                        </div>
                        <div class="col-auto">
                            <?php if(Gate::check('create wo type')): ?>
                                <a class="btn btn-secondary customModal" href="#" data-size="lg"
                                    data-url="<?php echo e(route('wo-type.create')); ?>" data-title="<?php echo e(__('Create Type')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/carecifn/public_html/preprod/resources/views/wo_type/index.blade.php ENDPATH**/ ?>