            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center g-2">
                        <div class="col">
                            <h5><?php echo e(__('Service & Part List')); ?></h5>
                        </div>
                        <div class="col-auto">
                                            ...
                                            <div class="cart-action">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show service & part')): ?>
                                                    <a class="avtar avtar-xs btn-link-warning text-warning customModal" data-bs-toggle="tooltip" data-size="lg"
                                                        ...
                                                        data-title="<?php echo e(__('Service & Part Detail')); ?>"> <i
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit service & part')): ?>
                                                    <a class="avtar avtar-xs btn-link-secondary text-secondary customModal"
                                                        ...
                                                        data-title="<?php echo e(__('Edit Service & Part')); ?>"> <i
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/carecifn/public_html/preprod/resources/views/service_part/index.blade.php ENDPATH**/ ?>