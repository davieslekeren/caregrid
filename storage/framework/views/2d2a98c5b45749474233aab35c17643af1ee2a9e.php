...
<?php $__env->startSection('content'); ?>
    <?php echo e(Form::model($workOrder, ['route' => ['workorder.update', \Illuminate\Support\Facades\Crypt::encrypt($workOrder->id)], 'method' => 'PUT'])); ?>
                    ...
                    <div class="info-group row">
                        <div class="form-group col-md-6">
                            <div class="form-group">
                                <?php echo e(Form::label('wo_id', __('Workorder Number'), ['class' => 'form-label'])); ?>
                                ...
                                <div class="input-group">
                                    ...
                                    <?php echo e(Form::text('wo_id', $workOrder->wo_id, ['class' => 'form-control', 'placeholder' => __('Enter Workorder Number')])); ?>

                                </div>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            <?php echo e(Form::label('wo_detail', __('WO Detail'), ['class' => 'form-label'])); ?> <span
                                class="text-danger">*</span>
                            <?php echo e(Form::textarea('wo_detail', null, ['class' => 'form-control', 'rows' => 1, 'required' => 'required'])); ?>

                        </div>
                        <div class="form-group col-md-6">
                            <?php echo e(Form::label('type', __('Type'), ['class' => 'form-label'])); ?> <span
                                class="text-danger">*</span>
                            <?php echo Form::select('type', $woTypes, null, ['class' => 'form-control hidesearch', 'required' => 'required']); ?>
                        ...
                        <div class="form-group col-md-6">
                            <?php echo e(Form::label('priority', __('Priority'), ['class' => 'form-label'])); ?> <span
                                class="text-danger">*</span>
                            <?php echo Form::select('priority', $priority, null, ['class' => 'form-control hidesearch', 'required' => 'required']); ?>

                        </div>

                        <div class="form-group col-md-6">
                            <?php echo e(Form::label('assign', __('Assign'), ['class' => 'form-label'])); ?> <span
                                class="text-danger">*</span>
                            <?php echo Form::select('assign', $users, null, ['class' => 'form-control hidesearch']); ?>

                        </div>
                        <div class="form-group col-md-6">
                            <?php echo e(Form::label('notes', __('Notes'), ['class' => 'form-label'])); ?>

                            <?php echo e(Form::textarea('notes', null, ['class' => 'form-control', 'rows' => 1])); ?>

                        </div>
                        <hr>
                        <div class="form-group col-md-6">
                            <?php echo e(Form::label('preferred_date', __('Preferred Date'), ['class' => 'form-label'])); ?>

                            <?php echo e(Form::date('preferred_date', null, ['class' => 'form-control'])); ?>

                        </div>
                        <div class="form-group col-md-6">
                            <?php echo e(Form::label('preferred_time', __('Preferred Time'), ['class' => 'form-label'])); ?>

                            <?php echo Form::select('preferred_time', $time, null, ['class' => 'form-control hidesearch']); ?>

                        </div>
                        <div class="form-group col-md-6">
                            <?php echo e(Form::label('preferred_note', __('Preference Note'), ['class' => 'form-label'])); ?>

                            <?php echo e(Form::textarea('preferred_note', null, ['class' => 'form-control', 'rows' => 1])); ?>
                                ...
                                <tbody data-repeater-item>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php echo e(Form::text('unit', null, ['class' => 'form-control unit', 'disabled'])); ?>
                            ...
                            <table class="display dataTable cell-border" data-repeater-list="parts">
                                ...
                                <tbody data-repeater-item>
                                    <tr>
                                        ...
                                        <td width="30%">
                                            <?php echo e(Form::select('service_part_id', $parts, null, ['class' => 'form-control hidesearch_part service_part_id'])); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/carecifn/public_html/preprod/resources/views/workorder/edit.blade.php ENDPATH**/ ?>