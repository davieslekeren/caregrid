...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            {{Form::text('email',$client->email,array('class'=>'form-control','placeholder'=>__('Enter email'),'required'=>'required'))}}
        </div>
        <div class="form-group col-md-6">
            {{Form::label('phone_number',__('Phone Number'),array('class'=>'form-label')) }} <span class="text-danger">*</span>
            {{Form::text('phone_number',$client->phone_number,array('class'=>'form-control','placeholder'=>__('Enter phone number'),'required'=>'required'))}}
        </div>
        <div class="form-group col-md-6">
            {{Form::label('company',__('Company'),array('class'=>'form-label')) }} <span class="text-danger">*</span>
            {{Form::text('company',$company,array('class'=>'form-control','placeholder'=>__('Enter company'),'reqired'=>"required", 'readonly'=>''))}}
        </div>
    </div>
    <div class=" col-md-12 mb-20">
        <h5> {{__('Branch Address')}}</h5>
    </div>
    <div class="row">
        <div class="form-group col-md-6">
